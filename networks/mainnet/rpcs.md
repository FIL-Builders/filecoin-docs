...
These endpoints are limited to the read-only [Filecoin JSON RPC API](../../reference-resources/json-rpc/) including read-only [Filecoin Eth RPC](../../reference-resources/json-rpc/eth.md) methods, except for the write operations [`MPoolPush`](../../reference-resources/json-rpc/mpool.md#mpoolpush) and [`EthSendRawTransaction`](../../reference-resources/json-rpc/eth.md#ethsendrawtransaction) for sending already signed messages.
