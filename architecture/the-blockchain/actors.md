...
For those familiar with the Ethereum virtual machine (EVM), _actors_ work similarly to [smart contracts](../../build-on-filecoin/fundamentals/). In the Filecoin network, there are two types of actors:
...
A [Merkle Directed Acyclic Graph (Merkle DAG)](../../reference-resources/general/glossary.md#merkle-directed-acyclic-graph) is used to map the state tree and the set of messages. Nodes in the state tree contain information on:
...
[Was this page helpful?](https://airtable.com/apppq4inOe4gmSSlk/pagoZHC2i1iqgphgl/form?prefill\_Page+URL=https://docs.filecoin.io/architecture/the-blockchain/actors)
