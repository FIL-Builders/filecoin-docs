...
1. The [`StorageMinerActor`](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#storagemineractor) processes proof of storage from a storage provider.
2. The storage provider is awarded storage power based on whether the proof is valid or not.
3. The [`StoragePowerActor`](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#storagepoweractor) accounts for the storage power.
...
5. Using the state information, the consensus mechanism randomly awards blocks to the storage providers with the most power, and the [`RewardActor`](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#rewardactor) sends FIL to storage providers.
...
* [CronActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#cronactor)
* [InitActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#initactor)
* [AccountActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#accountactor)
* [RewardActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#rewardactor)
* [StorageMarketActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#storagemarketactor)
* [StorageMinerActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#storagemineractor)
* [MultisigActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#multisigactor)
* [PaymentChannelActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#paymentchannelactor)
* [StoragePowerActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#storagepoweractor)
* [VerifiedRegistryActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#verifiedregistryactor)
* [SystemActor](https://docs.filecoin.io/reference-resources/built-in-actors/overview/#systemactor)
...
For information on how invoke and access built-in actors in your smart contracts, see the [developers guide](https://docs.filecoin.io/build-on-filecoin/developing-contracts/call-built-in-actors/).



[Was this page helpful?](https://airtable.com/apppq4inOe4gmSSlk/pagoZHC2i1iqgphgl/form?prefill\_Page+URL=https://docs.filecoin.io/reference-resources/built-in-actors)
