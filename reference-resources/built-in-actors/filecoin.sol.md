...
Before you can call a built-in actor using the API, you must [import filecoin.solidity using one of the available methods](../../build-on-filecoin/developing-contracts/#call-built-in-actors/#using-filecoinsolidity).

## Call a built-in actor

For available actors and methods see [Available actors and methods](../../build-on-filecoin/developing-contracts/#call-built-in-actors/#available-actors-and-methods).
...
[Was this page helpful?](https://airtable.com/apppq4inOe4gmSSlk/pagoZHC2i1iqgphgl/form?prefill\_Page+URL=https://docs.filecoin.io/reference-resources/built-in-actors/filecoin.sol)
