...
A summary of the Filecoin's EVM differences with Ethereum is available in the [FEVM - Difference with Ethereum section](../../build-on-filecoin/filecoin-evm-runtime/difference-with-ethereum.md).
...
[**ChainHead**](https://lotus.filecoin.io/reference-resources/lotus/chain/#chainhead)
...
[**ChainGetTipSetByHeight**](https://lotus.filecoin.io/reference-resources/lotus/chain/#chaingettipset)
...
[**ChainGetParentMessages**](https://lotus.filecoin.io/reference-resources/lotus/chain/#chaingetparentmessages)
...
[**WalletNew**](https://lotus.filecoin.io/reference-resources/lotus/wallet/#walletnew)
...
[**WalletBalance**](https://lotus.filecoin.io/reference-resources/lotus/wallet/#walletbalance)
...
[**MpoolPushMessage**](https://lotus.filecoin.io/reference-resources/lotus/mpool/#mpoolpushmessage)
...
Use [WalletSign](https://lotus.filecoin.io/reference-resources/lotus/wallet/#walletsign) to sign the message and send the signed message using [MpoolPush](https://lotus.filecoin.io/reference-resources/lotus/mpool/#mpoolpush).

You may also use this [Filecoin signing tool library](../general/tools.md).

### How do I retrieve the gas fees of a message?

Call [StateReplay](https://lotus.filecoin.io/reference-resources/lotus/state/#statereplay) and look up the `GasCost` in the response.

### How to get the gas estimation of a message?

You can estimate the gas cost of a message by calling [GasEstimateMessageGas](https://lotus.filecoin.io/reference-resources/lotus/gas/#gasestimatemessagegas). This API estimates the gas limit with a 25% overestimation based on the network condition under the given tipset key. You can change this value via the `GasLimitOverestimation` field.

### How do I ensure that all balances transfer in any messages are captured, including msig transfers?

Call [StateCompute](https://lotus.filecoin.io/reference-resources/lotus/state/#statecompute) or [StateReplay](https://lotus.filecoin.io/reference-resources/lotus/state/#statereplay) and go through all the transactions in the execution trace. Whenever the value `!=0 && exit code == 0`, it indicates a balance transfer has occurred.
...
[Was this page helpful?](https://airtable.com/apppq4inOe4gmSSlk/pagoZHC2i1iqgphgl/form?prefill\_Page+URL=https://docs.filecoin.io/reference-resources/exchanges/exchange-integration)
