---
description: Reference-only index of legacy/deprecated workflows.
---
...
This page is a reference-only index of legacy workflows kept for historical context.

**Use instead:** [Modern storage patterns](modern-storage-patterns.md) and [Deal Client is deprecated](deal-client-deprecated.md)
{% endhint %}

## How to use this page

* Use these links only when maintaining or migrating older systems.
* For new implementations, start from [Modern storage patterns](modern-storage-patterns.md).
* See [Deal Client is deprecated](deal-client-deprecated.md) for migration context.

## Legacy Deal Client workflow pages (GER-565 inventory)
