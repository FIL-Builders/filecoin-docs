...
1. Review the [available actors and methods](https://docs.filecoin.io/build-on-filecoin/developing-contracts/call-built-in-actors/#available-actors-and-methods).
2. [Import `filecoin.sol`](https://docs.filecoin.io/build-on-filecoin/developing-contracts/call-built-in-actors/#import-filecoinsol).
3. [Call a built-in actor](https://docs.filecoin.io/build-on-filecoin/developing-contracts/call-built-in-actors/#call-a-built-in-actor).
...
[Was this page helpful?](https://airtable.com/apppq4inOe4gmSSlk/pagoZHC2i1iqgphgl/form?prefill\_Page+URL=https://docs.filecoin.io/build-on-filecoin/developing-contracts/call-built-in-actors)
